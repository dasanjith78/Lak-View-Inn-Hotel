...
<div class="container">
    <div class="row">
        <div class="col-sm-4">
            ...
            <!-- RoomCarousel-->
            <div class="caption">Rooms<a href="rooms-tariff.jsp" class="pull-right"><i class="fa fa-edit"></i></a></div>
        </div>
        ...
        <div class="col-sm-4">
            ...
            <!-- RoomCarousel-->
            <div class="caption">Tour Packages<a href="gallery.jsp" class="pull-right"><i class="fa fa-edit"></i></a></div>
        </div>
        ...
        <div class="col-sm-4">
            ...
            <!-- RoomCarousel-->
            <div class="caption">Food and Drinks<a href="gallery.jsp" class="pull-right"><i class="fa fa-edit"></i></a></div>
        </div>
    </div>
</div>
</div>
